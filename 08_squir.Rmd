...
all.env <- read.csv(here("data/all.env.FINAL.csv"))
...
# final check for NAs/missing values where there shouldn't be
...
str(all.env.scaled)
# correlation matrix
cor.mat <- cor(all.env.scaled)
cor.mat <- cor(all.env.scaled[sapply(all.env.scaled,is.numeric)])
cor.mat
```
