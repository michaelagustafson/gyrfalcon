...
test.tif.14 <- terra::rast(here("data/ABoVE_2014lyrs/ABoVE_LandCover_Bh04v01_2014.tif"))
plot(test.tif.14)

test.tif2.14 <- terra::rast(here("data/ABoVE_2014lyrs/ABoVE_LandCover_Bh04v02_2014.tif"))
plot(test.tif2.14)

test.tif3.14 <- terra::rast(here("data/ABoVE_2014lyrs/ABoVE_LandCover_Bh03v01_2014.tif"))
plot(test.tif3.14)

test.tif4.14 <- terra::rast(here("data/ABoVE_2014lyrs/ABoVE_LandCover_Bh03v02_2014.tif"))
plot(test.tif4.14)

?src
m <- terra::mosaic(test.tif.14, test.tif2.14, test.tif3.14, test.tif4.14)
...
eg.focal <- focal(egforest, w=matrix(1, nrow=13, ncol=13), fun=sum, na.rm = TRUE)

eg.focal2 <- (eg.focal[[1]]/169)
plot(eg.focal2)
```
